package com.logistics.packages.infrastructure.messaging.consumers;
...
/**
 * Utility class for safe JSON node mapping to handle cross-account SQS payloads
 * without strict class validation.
 */
